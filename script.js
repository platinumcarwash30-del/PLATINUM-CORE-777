const translations = {
  en: {
    ...
    ipLabel: 'IP STATUS', legalNote: 'Original concept & authorship: Marko Ćuća · Trademark application submitted (ZIS, Serbia).', statementOne: 'ONE CORE.', statementTwo: 'EVERY BUSINESS.', statementThree: 'TOTAL CONTROL.', visionCalloutLabel: 'A MOMENT FOR THE VISION', visionCallout: 'Take a moment to discover the vision. If you are able, support the journey — together, we can change the world.',
  ...
  sr: {
    ...
    ipLabel: 'STATUS INTELEKTUALNE SVOJINE', legalNote: 'Originalni koncept i autorstvo: Marko Ćuća · Prijava žiga podneta (ZIS, Srbija).', statementOne: 'JEDNO JEZGRO.', statementTwo: 'SVAKI BIZNIS.', statementThree: 'POTPUNA KONTROLA.', visionCalloutLabel: 'TRENUTAK ZA VIZIJU', visionCallout: 'Odvojite malo vremena da upoznate viziju. Ukoliko ste u mogućnosti, pružite podršku — zajedno menjamo svet.',
